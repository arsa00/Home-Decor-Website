...
agencyRouter.route("/getAllAgencyRequestsByAgencyId").post((req, res) => new agency_controller_1.AgencyController().getAllAgencyRequestsByAgencyId(req, res));
agencyRouter.route("/acceptAgencyRequest").post((req, res) => new agency_controller_1.AgencyController().acceptAgencyRequest(req, res));
agencyRouter.route("/rejectAgencyRequest").post((req, res) => new agency_controller_1.AgencyController().rejectAgencyRequest(req, res));
